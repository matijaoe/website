    ...
    <div class="flex flex-col gap-12">
      <div class="max-w-xl">
        ...
        <div class="text-default-foreground max-w-xl leading-7 prose text-lg">
          ...
          <p>Beyond code, I'm deeply passionate about Bitcoin, dedicating my time to advocating for preserving our privacy, fostering self-sovereignty, enhancing financial literacy, and cultivating a low time preference mindset. I am also very much into economics, psychology, art and literature.</p>
        </div>
      </div>
    </div>
  </div>
