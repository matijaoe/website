...
const projects: Project[] = [
  ...
  },
  {
    ...
    tech: ['Nuxt', 'TypeScript', 'UnoCSS', 'Tanstack Query', 'bitcoinjs', 'Prisma', 'PlanetScale'],
    techPreview: ['Nuxt', 'ts', 'UnoCSS', 'Tanstack', 'Prisma'],
    timeframe: '2022',
  ...
  },
  {
    ...
    techPreview: ['Next', 'ts', 'React Query', 'Mantine UI', 'Nest.js', 'Prisma'],
    timeframe: '2022',
  ...
  },
  {
    ...
    tech: ['Nuxt', 'TypeScript', 'Tailwind', 'Nuxt UI', 'Drizzle', 'Prisma', 'Tauri', 'SQLite'],
    techPreview: ['Nuxt', 'ts', 'Nuxt UI', 'Prisma'],
    timeframe: '2023',
  ...
  },
  {
    ...
    thumbnail: '/projects/bitcoin-seed-finisher.webp',
    categories: [Category.hobby],
    color: '#027FC0',
  },
  {
